        ...
        if($this->url){
            ...
            if($this->parameter && is_string($this->parameter)) {
				...
				foreach($parameters as $k=>$v){
					if(strpos($v,'cript') == false && strpos($v,'cript')== false && strpos($v,'lert')== false && strpos($v,'lert')== false && strpos($v,'ouse')== false && strpos($v,'ouse')== false && strpos($v,'%23106%26%2397%26')== false && strpos($v,'%23106%26%2397%26')== false && strpos($v,'&#')== false && strpos($v,'&#')== false && strpos($v,'base64')== false && $k !='spm'){
						$parameter[$k] = $v;
					}										
				}
            }
