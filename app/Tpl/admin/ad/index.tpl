    ...
    <div class="J_tablelist table_list" data-acturi="{:U('ad/ajax_edit')}">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td align="center">{$ad_type_arr[$val['type']]}<if condition="$val.type eq 'image'"><notempty name="val['content']"><span class="attachment_icon J_attachment_icon" file-type="image" file-rel="{:attach($val['content'],'advert')}"><img src="__STATIC__/images/filetype/image_s.gif" /></span></notempty></if></td>
