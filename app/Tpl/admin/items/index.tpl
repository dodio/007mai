...
<div class="pad_lr_10" >
    ...
    <table width="100%" cellspacing="0">
		...
		<th width="50" align="center">缩略图</th>
                <th align="left" width="300"><span data-tdtype="order_by" data-field="title">商品名称</span></th>
		...
		<th width="50"><span data-tdtype="order_by" data-field="zc_id">专场ID</span></th>
                <th width="100">掌柜</th>
                <th width="70"><span data-tdtype="order_by" data-field="coupon_price">活动价</span></th>
		<th width="70"><span data-tdtype="order_by" data-field="coupon_rate">折扣比率</span></th>
		<th width="70"><span data-tdtype="order_by" data-field="totalfee">30天支出</span></th>
		<th width="70"><span data-tdtype="order_by" data-field="commission">佣金</span></th>
    	...
    	<tbody>
            ...
            <tr>
                ...
                <td align="right">
                    <div class="img_border"><a href="http://detail.tmall.com/item.htm?id={$val.num_iid}" target="_blank"><img src="{:attach(get_thumb($val['pic_url'], '_s'), 'item')}" width="32" width="32" class="J_preview" data-bimg="{:attach(get_thumb($val['pic_url'],'_m'), 'item')}"></a></div>
                </td>
		...
		<td align="center"><span data-tdtype="edit" data-field="zc_id" data-id="{$val.id}" class="tdedit">{$val.zc_id}</span></td>
                <td align="center">{$val.nick}</td>
                <td align="center" class="red">{$val.coupon_price}</td> 
		<td align="center" class="red">{$val.coupon_rate}</td>
		<td align="center">{$val.totalfee}</td>
