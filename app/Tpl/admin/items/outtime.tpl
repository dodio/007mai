...
<div class="pad_10" >
 ...
 <div class="J_tablelist table_list" data-acturi="{:U('items/ajax_edit')}">
    <table width="100%" cellspacing="0">
    	...
    	<tbody>
            ...
            <tr>
                ...
                <td align="center">{$val.coupon_end_time|frienddate}</td>
    ...
    <div class="btn_wrap_fixed">
        ...
        <input type="button" class="btn btn_submit" data-tdtype="batch_action" data-acttype="ajax" data-uri="{:U('items/add_time')}" data-name="id" data-msg="{:L('confirm_addtime')}" value="一键延时" />
