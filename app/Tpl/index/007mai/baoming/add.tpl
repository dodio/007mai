		...
		<form action="{:U('goods/goods_add',array('do'=>'submit'))}" method="post" name="form1" onsubmit="return check_zhe();">
			<div class="bm-form">
				...
				<table>
					...
					<tr>
						<th>开始时间：</th>
						<td><input name="coupon_start_time" type="text" id="coupon_start_time" class="form-int-short date" value="" /></td>
					</tr>
					<tr>
						<th>结束时间：</th>
						<td><input name="coupon_end_time" type="text" id="coupon_end_time" class="form-int-short date" value="" /></td>
					</tr>
				</table>
			</div>
			<div class="bm-form" style="border:0">
				<table>
					...
					<tr>
						<th>联系人手机：</th>
						<td><input name="telephone" type="text" id="telephone" class="form-int-short" value="{$info.mobile}" /></td>
					</tr>
					<tr>
						<th>联系人姓名：</th>
