              ...
              <a href="{:U('gift/index')}" target="_blank" class="mr20 btn_jfsc">情报商城</a> 
                <div style="display: none;" class="normal-side-box" id="top-side-box">
                    <div class="box-tips">
                        ...
                        <p class="other"> <a target="_blank" href="{:U('user/mingxi')}">我的情报</a>　｜　<a target="_blank" href="{:U('gift/index')}">情报商城</a> ｜ <a href="http://www.007mai.com/help/qingbao" target="_blank">快速获得情报!</a></p>
                    </div>
                </div>
            </div>
            <script>
