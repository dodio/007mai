...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="http://www.8mob.com/static/images/favicon.ico" media="screen" />
...
<body id="index">
<div class="header">
        <a class="logo" href="http://m.8mob.com"><span>全场九块九包邮<br>8mob.com</span></a>
        <div class="nav">
